...
const movies = [
  {title: "Madagascar", description: "Group of friends escape the zoo. Where will they go?", year: 2005, genres: ["Animation", "Adventure", "Comedy", "Family"]},
  ...
  {title: "Mile 22", description: "CIA Agent James Silva leads a top secret CIA Special Activities Division unit, code-named Overwatch, to infiltrate a Russian Federal Security Service (FSB) safe house in the United States.", year: 2018, genres: []}
]
